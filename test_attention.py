...
MODEL_PATH_CHANNEL_ITS = "outputs/unet_channel_its.pth"
CLEAR_EXT_ITS = ".png"
...
if __name__ == "__main__":
    ...
    model.load_state_dict(
        torch.load(MODEL_PATH_CHANNEL_ITS, map_location=device, weights_only=True)
    )
    model.eval()
    ...
    output_dir = "outputs/its comparison channel attention"
